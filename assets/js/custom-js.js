...
windowName:'Tchat' 
	...
	if(document.getElementById('chatben')) {
	window.setInterval(infoben, reloadTime);
	infoben();
	}
	$("#video2").click(function(){
		$('#video').html('<iframe frameborder="0" height="394" width="700" id="player_1" src="http://www.dailymotion.com/embed/video/x153ng0?autoPlay=1&logo=on"></iframe>');
		});
	$("#video3").click(function(){
		$('#video').html('<div id="player_1" style="width=700px;height=394px;"></div>');
			jwplayer('player_1').setup({stretching: "exactfit",primary: "html5",autostart: "true",controls: "true",aspectratio: '16:9',width: '100%',height: '100%' ,rtmp: {bufferlength: 0.9},sources: [ {file: "rtmp://62.210.182.114/live_all/flv:snipy.flv"}		 ]	  });
	});
	$("#video4").click(function(){
		$('#video').html('<iframe src="http://www.twitch.tv/gamers_city/embed" id="player_1" frameborder="0" scrolling="no" height="394" width="700"></iframe>');
		});
	$("#video5").click(function(){
		$('#video').html('<iframe id="player_1" height="394" width="700" src="http://hitbox.tv/#!/embed/snipy44" frameborder="0" allowfullscreen></iframe>');
		});
	$("#video6").click(function(){
		$('#video').html('<iframe src="http://www.gaminglive.tv/embed-player/snipy44" width="700" height="394" class="gaminglive-player" frameborder="0"></iframe>');
		});
	$("#video7").click(function(){
		$('#video').html('<div id="player_1" style="width=700px;height=394px;"></div>');
			jwplayer('player_1').setup({stretching: "exactfit",primary: "html5",autostart: "true",controls: "true",aspectratio: '16:9',width: '100%',height: '100%' ,rtmp: {bufferlength: 0.9},sources: [ {file: "rtmp://62.210.182.114/live_all2/flv:snipy.flv"}		 ]	  });
	});
	$("#video8").click(function(){
		$('#video').html('<iframe src="http://www.twitch.tv/benzaie/embed" id="player_1"  frameborder="0" scrolling="no" width="700" height="394"></iframe>');
		});
